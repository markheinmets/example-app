<x-layout>
    ...
    <x-slot:actions>
        <a href="{{route('authors.create')}}" class="bg-slate-800 text-white px-2 py-1 text-sm hover:bg-slate-700">Create</a>
    </x-slot:actions>
                ...
                <tr>
                    ...
                    <td>
                        <div class="grid grid-cols-2">
                            <a href="{{route('authors.edit', $author)}}" class="font-medium">
                                Edit
                            </a>
